<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"E:\phpStudy\WWW\tp5_admin\addons\user\view\index\register.html";i:1513567017;s:61:"E:\phpStudy\WWW\tp5_admin\addons\user\view\layout\common.html";i:1513925285;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="well">
                        <form id="registerForm" method="POST" action="#">
                            ...
                            <a href="<?php echo addon_url('user/index/login'); ?>" class="btn btn-default btn-block">已经账号,立即登录</a>
                        </form>
                    </div>
                </div>
                <div class="col-md-6 col-xs-12">
