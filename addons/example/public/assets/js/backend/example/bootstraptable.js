            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'operate', rowspan: 2, title: __('Operate'), table: table, events: Table.api.events.operate,
                            buttons: [
                    ...
                    [
                        ...
                        {field: 'id', title: __('联动搜索'), searchList: function () {
                        ...
                        {field: 'updatetime', title: __('Update time'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange', options: {}},
                    ],
                ],
                //禁用默认搜索
                search: false,
